...
export const TechStackInfo: Component = () => {
  ...
  const techStacks: TechStack[] = [
      ...
      technologies: [
        {
          ...
          alternatives: [
            ...
            },
            {
              name: 'Node.js',
              reason:
                'JavaScript runtime limitations for intensive computation',
            },
          ],
          keyFeatures: [
          ...
          benchmarkData: [
            {
              metric: 'Fractal Generation',
              value: '< 50ms',
              comparison: '10x faster than Python',
            },
            {
              metric: 'Memory Usage',
              value: '< 100MB',
              comparison: '5x lower than Java',
            },
            {
              metric: 'Startup Time',
              value: '< 5ms',
              comparison: '50x faster than JVM',
            },
            {
              metric: 'Binary Size',
              value: '< 20MB',
              comparison: 'Static linking included',
            },
          ],
        },
        {
          ...
          version: '0.7+',
          description:
            'Modern, ergonomic web framework built on Tokio async runtime',
          whyChosen:
            'Axum provides excellent performance with type-safe routing, built-in middleware support, and seamless integration with the Tokio ecosystem.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'Actix-web',
              reason: 'Slightly faster but more complex API',
            },
            { name: 'Warp', reason: 'Good performance but less ergonomic' },
            {
              name: 'Rocket',
              reason: 'More traditional but less performant',
            },
          ],
          keyFeatures: [
        ...
        },
        {
          ...
          whyChosen:
            'PostgreSQL offers superior performance for complex queries, excellent JSON support, and robust ACID guarantees needed for reliable data storage.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'MySQL',
              reason: 'Less advanced feature set and JSON support',
            },
            {
              name: 'SQLite',
              reason: 'Single-user limitations for web applications',
            },
            {
              name: 'MongoDB',
              reason: 'No ACID guarantees and query limitations',
            },
          ],
          keyFeatures: [
    ...
    },
    {
      category: 'frontend',
      description:
        'Reactive, high-performance user interface built for real-time interactions',
      technologies: [
        {
          name: 'SolidJS',
          version: '1.8+',
          description:
            'Fine-grained reactive UI library with exceptional performance',
          whyChosen:
            'SolidJS provides React-like ergonomics with superior performance, no virtual DOM overhead, and perfect for real-time fractal visualization updates.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'React',
              reason: 'Virtual DOM overhead affects real-time performance',
            },
            { name: 'Vue', reason: 'Reactive system not as fine-grained' },
            {
              name: 'Svelte',
              reason: 'Good performance but less mature ecosystem',
            },
          ],
          keyFeatures: [
          ...
          benchmarkData: [
            {
              ...
              value: '< 16ms',
              comparison: '3x faster than React',
            },
            {
              metric: 'Update Performance',
              value: '< 1ms',
              comparison: 'No virtual DOM diff',
            },
            {
              metric: 'Bundle Size',
              value: '< 50KB',
              comparison: '50% smaller than React',
            },
            {
              metric: 'Memory Usage',
              value: '< 20MB',
              comparison: 'No virtual DOM memory',
            },
          ],
        },
        {
          ...
          version: '5.0+',
          description:
            'Typed superset of JavaScript providing development-time safety',
          whyChosen:
            'TypeScript eliminates entire classes of runtime errors, improves code maintainability, and provides excellent IDE support for complex mathematical operations.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'JavaScript',
              reason: 'Lack of type safety for complex applications',
            },
            { name: 'Flow', reason: 'Less adoption and weaker ecosystem' },
            {
              name: 'PureScript',
              reason: 'Too different from JavaScript ecosystem',
            },
          ],
          keyFeatures: [
        ...
        },
        {
          ...
          version: '3.4+',
          description:
            'Utility-first CSS framework optimized for rapid development',
          whyChosen:
            'Tailwind provides consistent design system, excellent performance with purging, and perfect for creating the dark, eerie aesthetic we need.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              ...
              reason: 'Runtime overhead and larger bundles',
            },
            {
              name: 'CSS Modules',
              reason: 'Less design system consistency',
            },
            {
              name: 'Bootstrap',
              reason: 'Too opinionated and larger bundle size',
            },
          ],
          keyFeatures: [
      ...
      technologies: [
        {
          ...
          whyChosen:
            'Docker ensures consistent environments across development and production, efficient resource utilization, and easy scaling.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'Podman',
              reason: 'Good alternative but less ecosystem support',
            },
            { name: 'LXC', reason: 'More complex setup and management' },
            {
              name: 'Native deployment',
              reason: 'Environment inconsistencies',
            },
          ],
          keyFeatures: [
        ...
        },
        {
          ...
          whyChosen:
            'Nginx provides excellent static file serving, efficient reverse proxying, and advanced features like rate limiting and compression.',
          performanceCharacteristics: [
          ...
          alternatives: [
            {
              name: 'Apache',
              reason: 'Higher memory usage and less efficient',
            },
            {
              name: 'Caddy',
              reason: 'Easier config but less performance tuning',
            },
            {
              name: 'Traefik',
              reason: 'Good for microservices but more complex',
            },
          ],
          keyFeatures: [
  ...
  const getCurrentTechnologies = () => {
    return (
      techStacks.find((stack) => stack.category === activeCategory())
        ?.technologies || []
    );
  };

  const getPerformanceBarWidth = (value: number, category: string) => {
    const comparison = performanceComparisons.find(
    ...
    <div class="space-y-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-neutral-500 max-w-3xl mx-auto leading-relaxed">
          Every technology choice is deliberate, optimized for performance,
          and aligned with our philosophy of computational precision. Here's
          why each tool earns its place in this digital ecosystem.
        </p>
      </div>
      ...
      <Show when={techStacks.find((s) => s.category === activeCategory())}>
        <div class="text-center mb-8">
          <p class="text-neutral-400 max-w-2xl mx-auto">
            {
              techStacks.find((s) => s.category === activeCategory())!
                .description
            }
          </p>
        </div>
          ...
          {(tech) => (
            ...
            >
              <div class="flex items-center justify-between mb-4">
                <h3 class="text-xl font-mono text-neutral-100">
                  {tech.name}
                </h3>
            ...
            {(comparison) => (
              <div>
                <div class="flex items-center justify-between mb-3">
                  <h4 class="text-lg font-mono text-neutral-400">
                    {comparison.category}
                  </h4>
                ...
                <div class="space-y-3">
                  <div class="flex items-center gap-4">
                    <div class="w-16 text-sm font-mono text-neutral-400">
                      Rust
                    </div>
                    <div class="flex-1 bg-neutral-800 rounded-full h-6 relative">
                      <div
                        ...
                        style={{
                          width: `${getPerformanceBarWidth(comparison.rust, comparison.category)}%`,
                        }}
                      >
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-neutral-800 rounded-full h-6 relative">
                      <div
                        ...
                        style={{
                          width: `${getPerformanceBarWidth(comparison.javascript, comparison.category)}%`,
                        }}
                      >
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-neutral-800 rounded-full h-6 relative">
                      <div
                        ...
                        style={{
                          width: `${getPerformanceBarWidth(comparison.python, comparison.category)}%`,
                        }}
                      >
                        <span class="text-xs font-mono text-white">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-neutral-800 rounded-full h-6 relative">
                      <div
                        ...
                        style={{
                          width: `${getPerformanceBarWidth(comparison.java, comparison.category)}%`,
                        }}
                      >
                        <span class="text-xs font-mono text-white">
          ...
          <div class="bg-neutral-900 border border-neutral-700 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-8">
              ...
              <div class="grid md:grid-cols-2 gap-8">
                {/* Why chosen */}
                <div>
                  <h4 class="text-lg font-mono text-neutral-300 mb-3">
                    WHY CHOSEN
                  </h4>
                    ...
                    <For each={selectedTech()!.alternatives}>
                      {(alt) => (
                        <div class="bg-neutral-800/50 rounded-sm p-3">
                          <div class="font-mono text-sm text-neutral-300 mb-1">
                            {alt.name}
                          </div>
              ...
              <Show when={selectedTech()!.benchmarkData}>
                <div class="mt-8 pt-6 border-t border-neutral-800">
                  <h4 class="text-lg font-mono text-neutral-300 mb-4">
                    BENCHMARK DATA
                  </h4>
                    ...
                    <For each={selectedTech()!.benchmarkData}>
                      {(benchmark) => (
                        <div class="bg-neutral-800/30 rounded-sm p-4">
                          ...
                          <div class="text-xl font-mono text-green-400 mb-1">
                            {benchmark.value}
                          </div>
                          <div class="text-xs text-neutral-600">
