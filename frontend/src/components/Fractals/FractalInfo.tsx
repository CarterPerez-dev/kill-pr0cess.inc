...
export const FractalInfo: Component<FractalInfoProps> = (props) => {
  ...
  const getTheoreticalInfo = () => {
    if (props.fractalType === 'mandelbrot') {
      ...
      return {
        ...
        significance:
          'Each point in the Mandelbrot set corresponds to a connected Julia set.',
      };
    }
  };
  ...
  const getPerformanceAnalysis = () => {
    ...
    return {
      efficiency,
      parallelRating,
      computationRate: ((pixelsComputed / computationTime) * 1000).toFixed(
        0,
      ),
      memoryEfficiency:
        memoryUsage < 100
      ...
      <div class="fixed bottom-4 left-4 w-96 z-20">
        ...
        >
          ...
          <Show when={activeSection() === 'math'}>
            <div class="p-4 space-y-4">
                ...
                <div class="space-y-2 text-xs">
                  <div class="flex justify-between">
                    ...
                    <span class="text-neutral-400 font-mono">
                      {mathematicalProps.centerPoint}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Magnification:</span>
                    <span class="text-neutral-400 font-mono">
                      {formatNumber(mathematicalProps.magnification)}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Pixel Size:</span>
                    <span class="text-neutral-400 font-mono">
                      {mathematicalProps.pixelSize.toExponential(3)}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Plane Width:</span>
                    <span class="text-neutral-400 font-mono">
                      {mathematicalProps.complexPlaneWidth.toFixed(6)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-neutral-900/50 rounded-lg p-3">
                ...
                <div class="space-y-2 text-xs">
                  <div class="flex justify-between">
                    ...
                    <span class="text-neutral-400 font-mono">
                      {mathematicalProps.iterationDepth}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Escape Radius:</span>
                    <span class="text-neutral-400 font-mono">
                      {mathematicalProps.escapeRadius}
                    </span>
                  </div>
                  <Show when={props.parameters.juliaConstant}>
                    <div class="flex justify-between">
                      ...
                      <span class="text-neutral-400 font-mono">
                        {props.parameters.juliaConstant!.real.toFixed(4)} +{' '}
                        {props.parameters.juliaConstant!.imag.toFixed(4)}i
                      </span>
                    </div>
                  </Show>
                </div>
              ...
              <div class="text-xs text-neutral-600 italic leading-relaxed">
                "In the infinite complexity of fractals, we glimpse the
                mathematical underpinnings of chaos and beauty."
              </div>
            </div>
          </Show>
          ...
          <Show when={activeSection() === 'performance' && props.metadata}>
            <div class="p-4 space-y-4">
              <div class="bg-neutral-900/50 rounded-lg p-3">
                ...
                <div class="space-y-2 text-xs">
                  <div class="flex justify-between">
                    ...
                    <span class="text-neutral-400 font-mono">
                      {props.metadata!.computationTime}ms
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Pixels:</span>
                    <span class="text-neutral-400 font-mono">
                      {formatNumber(props.metadata!.pixelsComputed)}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Rate:</span>
                    <span class="text-neutral-400 font-mono">
                      {formatNumber(props.metadata!.pixelsPerSecond)}/sec
                    </span>
                  </div>
                  <div class="flex justify-between">
              ...
              <div class="bg-neutral-900/50 rounded-lg p-3">
                ...
                <div class="space-y-2 text-xs">
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Efficiency:</span>
                    <span class="text-neutral-400 font-mono">
                      {(props.metadata!.parallelEfficiency * 100).toFixed(1)}
                      %
                    </span>
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="text-cyan-400 font-mono">
                      {performanceAnalysis?.parallelRating}
                    </span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-neutral-600">Memory:</span>
                    <span class="text-neutral-400 font-mono">
                      {props.metadata!.memoryUsage.toFixed(1)}MB
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-gradient-to-r from-neutral-900/50 to-cyan-900/20 rounded-lg p-3">
                <div class="text-xs text-cyan-400 font-mono uppercase mb-2">
                  Rust Performance
                </div>
                <div class="text-xs text-neutral-400 leading-relaxed">
                  Zero-cost abstractions and SIMD optimization deliver
                  mathematical precision at silicon speed. Each iteration
                  computed with memory safety guaranteed.
                </div>
              </div>
            </div>
          </Show>
          ...
          <Show when={activeSection() === 'theory'}>
            <div class="p-4 space-y-4">
              <div>
                <h4 class="text-sm font-mono text-neutral-300 mb-2">
                  {theoreticalInfo.title}
                </h4>
              ...
              <div class="space-y-2 text-xs">
                <div class="flex justify-between">
                  ...
                  <span class="text-neutral-400">
                    {theoreticalInfo.discoverer}
                  </span>
                </div>
                <div class="flex justify-between">
                  <span class="text-neutral-600">Dimension:</span>
                  <span class="text-neutral-400 font-mono">
                    {theoreticalInfo.dimension}
                  </span>
                </div>
              </div>
