...
const ProjectsRoute: Component = () => {
  return (
    <>
      ...
      <Meta name="description" content="Explore GitHub repositories, code artifacts, and technical projects showcasing computational precision and performance optimization." />
      <Meta name="keywords" content="github, repositories, projects, code, rust, typescript, performance" />
      <Projects />
    </>
  );
};
