...
const IndexRoute: Component = () => {
  ...
  return (
    <>
      <Title>
        Performance Showcase | Computational Precision Meets Dark Aesthetics
      </Title>
      <Meta
        name="description"
        content="Explore high-performance computing, real-time fractal generation, and system metrics in a dark, contemplative interface."
      />
      <Meta
        name="keywords"
        content="performance, rust, solidjs, fractals, system metrics, computational showcase"
      />
      <Home />
    </>
  );
